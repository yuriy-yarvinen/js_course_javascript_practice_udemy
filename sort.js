...
function sortBy(arr, sortBY, sortOrder) {
	...
	if (sortBY === 'review') {
		if (sortOrder === 'desc') {
			...
			template.sort((a, b) => a.reviewsNumber < b.reviewsNumber ? 1 : -1);
	...
	if (sortBY === 'price') {
		if (sortOrder === 'desc') {
			...
			template.sort((a, b) => a.priceNumber < b.priceNumber ? 1 : -1);
...
const itemsReviewSortDesc = sortBy(items, 'review', 'desc');
const itemsReviewSortAsc = sortBy(items, 'review', 'asc');
const itemsPriceSortDesc = sortBy(items, 'price', 'desc');
const itemsPriceSortAsc = sortBy(items, 'price', 'asc');

console.log(itemsReviewSortDesc);
console.log(itemsReviewSortAsc);
console.log(itemsPriceSortDesc);
console.log(itemsPriceSortAsc);
